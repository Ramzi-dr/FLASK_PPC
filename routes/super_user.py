...
def init_super_user_routes(db):
    ...
    (Admins only. Requires 'super_password', 'email', 'new_password', 'force': true)
    """
    ...
    def reset_user_password():
        ...
        try:
            ...
            # Get hashed super_password from env (bcrypt hash stored in DB)
            ...
            # Validate super_password against bcrypt hash
            ...
            # Always save user password with Werkzeug (so login works)
